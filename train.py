...
if __name__ == '__main__':
    ...
    fix_random_seed(42)
    experiment = ExperimentSetup(name='gcn_conv_drop_edge', create_latest=True, long_description="""
    Use 1 unique GCNConvolutions for training
    Use DropEdge on undirected input graph with dropout rate of 0.3
    """)

    model = ABCDE(nb_gcn_cycles=5, lr_reduce_patience=3)
    ...
    trainer = pl.Trainer(logger=[
                         ...
                         max_epochs=10, terminate_on_nan=True,
